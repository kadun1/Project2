...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=6e849d5859a329e5feb3f360c2ba6b10"></script>
...
mapOption = { 
    center: new kakao.maps.LatLng(37.748253, 127.055564), // 지도의 중심좌표
    level: 3 // 지도의 확대 레벨
};
...
//마커가 표시될 위치입니다 
var markerPosition  = new kakao.maps.LatLng(37.748253, 127.055564); 
